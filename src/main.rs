...
fn main() {
    ...
    //     let vytvoreno = build::make(PathBuf::from(args.arg_part.unwrap()),
    //                                 PathBuf::from(args.arg_destination.unwrap()),
    //                                 args.arg_transformation);
...
//     assert_eq!(args.arg_transformation,
//                vec![Transformations::Php, Transformations::Md2html, Transformations::Html2elm]);
